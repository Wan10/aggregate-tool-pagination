...
Generator.prototype.queryPagingOptions = function (page, limit, options) {
    return queryPagingOptions(page, limit, options);
}

Generator.prototype.queryPagingOptionsSample = function (page, limit, options) {
    return queryPagingOptionsSample(page, limit, options);
}

Generator.prototype.querySelect = function (search) {
    return querySelect(search);
}

Generator.prototype.queryPopulateAge = function (populate) {
    return queryPopulateAge(populate);
}

Generator.prototype.querySearchAge = function (search, containKeys) {
    return querySearchAge(search, containKeys);
}

Generator.prototype.querySearchAllAge = function (search, containKeys) {
    return querySearchAllAge(search, containKeys);
}


Generator.prototype.isEmpty = function (variable) {
